...
<%
    ...
    DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_user_message_compose_message_init, "| Visit By - " + session_userName + " (" + session_userTypeDesc + ") |"));
...
<html>
    <head>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            if(document.getElementById('mcmbToOriginal')!=null)
            {
            ...
            if(document.getElementById('cmbTo')!=null)
            {
            document.getElementById('hdnSelectedRecipients').value = document.getElementById('cmbTo').value+'*';
            ...
            if(document.getElementById('cmbTo')!=null)
            {
            document.getElementById('cmbTo').selectedIndex = 0;
            }
                                                                ...
                                                                <td align="center" valign="top"><table width="100%" height="16" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10"></td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Compose New Message</td>
                                                                                        <td width="10"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="10"></td>
                                                                                                ...
                                                                                                <table border="0" cellspacing="0" cellpadding="0" class="cits_table_boder" align="center">
                                                                                                    <tr>
                                                                                                        <td align="center" valign="top"><table border="0" cellspacing="1" cellpadding="3" >
                                                                                                                <tr>
                                                                                                                    <td align="right" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text" >To <span class="cits_common_text">(Recipient<%=(session_userType.equals(LCPL_Constants.user_type_bank_user) || session_userType.equals(LCPL_Constants.user_type_settlement_bank_user)) ? "" : "/s"%>)</span> :</td>
                                                                                                                    <td align="left" valign="middle" bgcolor="#DFEFDE" ><table border="0" cellpadding="0" cellspacing="0">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td>
                                                                                                                                    ...
                                                                                                                                    %>
                                                                                                                                    <select name="cmbTo" class="cits_field_border" id="cmbTo" >
                                                                                                                                        <option value="<%=LCPL_Constants.status_all%>" >-Select Recipient-</option>
                                                                                                                                        <%

                                                                                                                                            if (colMsgTo != null && !colMsgTo.isEmpty())
                                                                                                                                            {

                                                                                                                                                for (Recipient msgTo : colMsgTo)
                                                                                                                                                {

                                                                                                                                        %>
                                                                                                                                        <option value="<%=msgTo.getRecipientCode()%>"><%=msgTo.getRecipientCode() + " - " + msgTo.getRecipientName()%></option>
                                                                                                                                        <%
                                                                                                                                ...
                                                                                                                                <td align="left" valign="top">
                                                                                                                                    <select name="mcmbToOriginal" size="<%=(colMsgTo != null && !colMsgTo.isEmpty()) ? colMsgTo.size() : "0"%>" multiple class="cits_field_border" id="mcmbToOriginal" style="min-width:230px">
                                                                                                                                        <%  if (colMsgTo != null && !colMsgTo.isEmpty())
                                                                                                                                            {
                                                                                                                                ...
                                                                                                                                <td align="right" valign="top"><select name="mcmbToSelected" size="<%=(colMsgTo != null && !colMsgTo.isEmpty()) ? colMsgTo.size() : "0"%>" multiple class="cits_field_border" id="mcmbToSelected" style="min-width:230px">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" valign="middle" bgcolor="#DFEFDE" ><input name="txtSubject" type="text" class="cits_field_border" id="txtSubject" size="80" maxlength="100"/></td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" valign="middle" bgcolor="#DFEFDE" ><table border="0" cellpadding="0" cellspacing="0">
                                                                                                                            <tr>
                                                                                                                                <td><textarea cols="80" rows="10" name="txaMessage" id="txaMessage" class="cits_field_border" onKeydown="Get_Length(this.form.txaMessage)" onKeyup="Set_Length(this.form.txaMessage)"></textarea>                                                                                                                                </td>
                                                                                                                                <td>&nbsp;</td>

...
<html>
    <head>
        <title>OUSDPS Web - User Account Locked</title>
                                                                                        ...
                                                                                        <td height="22"><table width="100%" height="22" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="left"><div style="padding:1;height:100%;width:100%;">
                                                                                                            ...
                                                                                                            <script language="JavaScript" vqptag="doc_level_settings" is_vqp_html=1 vqp_datafile0="<%=request.getContextPath()%>/js/reLoginMenu.js" vqp_uid0=399990>cdd__codebase = "<%=request.getContextPath()%>/js/";
                                                                cdd__codebase399990 = "<%=request.getContextPath()%>/js/";</script>
                                                ...
                                                <tr>
                                                    <td  height="470" align="center" valign="top" class="cits_bgCommon">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td height="115" class="cits_bgUserAccountLocked"></td>
                                                            </tr>
                                                            <tr>

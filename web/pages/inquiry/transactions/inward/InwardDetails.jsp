...
<html>
    <head>
        <title>OUSDPS Web - Inward Details</title>
<link href="<%=request.getContextPath()%>/css/cits.css" rel="stylesheet" type="text/css" />
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            {			
                var formName = "frmDownload_" + index;
				
                document.getElementById(formName).action="DownloadReport.jsp";
            ...
            function downloadSignature(index)
            {
                ...
                document.getElementById(formName).action="DownloadSignature.jsp";
                document.getElementById(formName).submit();			
            }
...
<tr>
                  ...
                  <tr>
                                                    ...
                                                    <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="10">&nbsp;</td>
                                                                <td align="left" valign="top" class="cits_header_text">Inward Details</td>
                                                                <td width="10">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td height="15"></td>
                                                            ...
                                                            <tr>
                                                                <td width="10"></td>
                                                                <td align="center" valign="top" class="cits_header_text"><form id="frmIwdDownload" name="frmIwdDownload" method="post" action="InwardDetails.jsp">
                                                                                            ...
                                                                                            <td align="center" valign="top" ><table border="0" cellspacing="1" cellpadding="3" >
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="left" valign="middle" bgcolor="#DFEFDE" ><%
                                                                                                            ...
                                                                                                            {
                                                                                                            %>
                                                                                                            <select name="cmbBank" id="cmbBank" onChange="isSearchRequest(false);frmIwdDownload.submit()" class="cits_field_border" <%=(userType.equals(LCPL_Constants.user_type_bank_user) || userType.equals(LCPL_Constants.user_type_settlement_bank_user))? "disabled" : ""%>>
                                                                                                                <%
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td colspan="2" align="right" bgcolor="#CDCDCD" class="cits_tbl_header_text"><table cellpadding="0" cellspacing="0" border="0">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="5"></td>
                                                                                                                    <td align="right"><input name="btnSearch" id="btnSearch" value="Search" type="button" onClick="isSearchRequest(true);frmIwdDownload.submit()"  class="cits_custom_button"/></td>
                                                                                                                </tr>
                                                                                                            </table></td>
                                                                                                    </tr>
                                                                                                </table></td>
                                                                                        ...
                                                                                        <td><div id="resultdata">
                                                                                              ...
                                                                                              <tr>
                                                                                                    ...
                                                                                                    <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>"  onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                        ...
                                                                                                        <td align="center"  class="cits_common_text"><span class="cits_common_text" title="<%=iwdFile.getBankFullName()%>"><%=iwdFile.getBank() + " - " + iwdFile.getBankShortName()%></span></td>
                                                                                                      ...
                                                                                                      <td align="center"  class="cits_common_text"><%=iwdFile.getCreatedTime()%></td>
                                                                                                        <td align="center"  class="cits_common_text">
                                                                                                            ...
                                                                                                            <%
                                                                                                                ...
                                                                                                                {
                                                                                                            %>                                                                                                               
                                                                                                            <span class="cits_success" title="Report Available">RA</span>
                                                                                                            <%                                                                            }
                                                                                                            else
                                                                                                            {
                                                                                                            %>

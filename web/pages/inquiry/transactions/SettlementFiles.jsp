...
<%
    ...
    else
    {
        ...
        if (!(userType.equals(LCPL_Constants.user_type_lcpl_super_user) || userType.equals(LCPL_Constants.user_type_lcpl_supervisor) || userType.equals(LCPL_Constants.user_type_settlement_bank_user) || userType.equals(LCPL_Constants.user_type_lcpl_bcm_operator)))
        {
            session.invalidate();
...
<%
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        isSubBankAvailable = DAOFactory.getInwardFilesDAO().isSubBankInwardFileAvailable(bankCode, winSess, LCPL_Constants.report_type_iwd_report_settlement, LCPL_Constants.status_yes, fromBusinessDate, toBusinessDate);
        colResult = DAOFactory.getInwardFilesDAO().getInwardFileDetails(bankCode, winSess, LCPL_Constants.report_type_iwd_report_settlement, LCPL_Constants.status_yes, fromBusinessDate, toBusinessDate);
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Settlement Files</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="10"></td>
                                                                                        <td align="center" valign="top" class="cits_header_text"><form id="frmIwdDownload" name="frmIwdDownload" method="post" action="SettlementFiles.jsp">
                                                                                                        ...
                                                                                                        <td><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                                                                                                <tr>
                                                                                                                    <td align="center" valign="top" ><table border="0" cellspacing="1" cellpadding="3" >
                                                                                                                            <tr>
                                                                                                                                <td align="left" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text" >Settlement Bank :</td>
                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" ><%
                                                                                                                                    try
                                                                                                                                    {
                                                                                                                                    %>
                                                                                                                                    <select name="cmbBank" id="cmbBank" onChange="isSearchRequest(false);
                                                                                                                                                    frmIwdDownload.submit()" class="cits_field_border" <%=(userType.equals(LCPL_Constants.user_type_settlement_bank_user) || userType.equals(LCPL_Constants.user_type_bank_user))? "disabled" : ""%>>
                                                                                                                                        <%

...
<%@page import="lk.com.ttsl.ousdps.dao.curuploadingfile.*" errorPage="../../../../error.jsp"%>
...
<%
    ...
    Collection<CurUploadingFile> colResult = null;

    colResult = DAOFactory.getCurUploadingFileDAO().getCurUploadingFileDetails();

    DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_user_inquiry_transaction_ows_currently_transmitting_files, "| Result Count - " + colResult.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Currently Transmitting File(s)</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                        ...
                                                                                        <td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                                                                                                <tr>
                                                                                                    <td><table border="0" cellpadding="0" cellspacing="0">
                                                                                                            ...
                                                                                                            <%   }
                                                                                                            else if (colResult != null && colResult.size() > 0)
                                                                                                            {
                                                                                                            %>
                                                                                                            <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td><table  border="0" cellspacing="1" cellpadding="3" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td  align="center" bgcolor="#B3D5C0" class="cits_tbl_header_text">Outward 
                                                                                                                                                Bank</td>
                                                                                                                                        ...
                                                                                                                                        <%
                                                                                                                                            int rowNum = 0;
                                                                                                                                            int acpNoOfBatches = 0;
                                                                                                                                            int acpNoOfTransactions = 0;
                                                                                                                                            int rjtNoOfBatches = 0;
                                                                                                                                            int rjtNoOfTransactions = 0;
                                                                                                                                            int expNoOfBatches = 0;
                                                                                                                                            int expNoOfTransactions = 0;

                                                                                                                                            for (CurUploadingFile cf : colResult)
                                                                                                                                            {
                                                                                                                                                rowNum++;                                                                                                                                                
                                                                                                                                        %>
                                                                                                                                        <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>"  onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                                            ...
                                                                                                                                            <td  align="center"  class="cits_common_text"><span class="cits_common_text" title="<%=cf.getOwBankFullName()%>"><%=cf.getOwBank() + " - " + cf.getOwBankShortName()%></span></td>
                                                                                                                                            
                                                                                                                                            <td  align="center"  class="cits_common_text"><%=cf.getFileId()%></td>
                                                                                                                                            <td  align="center"  class="cits_common_text"><%=cf.getTransmitStartTime() %></td>

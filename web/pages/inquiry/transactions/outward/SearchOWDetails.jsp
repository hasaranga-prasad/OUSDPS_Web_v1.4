...
<%
    ...
    else
    {
        ...
        if (!(userType.equals(LCPL_Constants.user_type_lcpl_super_user) || userType.equals(LCPL_Constants.user_type_bank_user) || userType.equals(LCPL_Constants.user_type_settlement_bank_user)))
        {
            session.invalidate();
...
<%
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        //colResult = DAOFactory.getOWDetailsDAO().getOWDetails(LCPL_Constants.status_all, LCPL_Constants.status_all, desBankCode, desBranchCode, originalBankCode, originalBranchCode, transCode, returnCode, winSess, fromBusinessDate, toBusinessDate, fromValueDate, toValueDate, fileId, desActNo, desActName, orgActNo, orgActName, minAmount, maxAmount);
        //DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_user_inquiry_transaction_adhoc_reports, "| Search Criteria - (Originate Bank : " + originalBankCode + ", Originate Branch : " + originalBranchCode + ", Originate Account No. : " + orgActNo + ", Originate Account Name : " + orgActName + ", Destination Bank : " + desBankCode + ", Destination Branch : " + desBranchCode + ", Destination Account No. : " + desActNo + ", Destination Account Name : " + desActName + ", Transaction type : " + transCode + ", Return reason : " + returnCode + ", Max Amount : " + maxAmount + ", Min Amount : " + minAmount + ", File Id : " + fileId + ", Bus.Date From : " + fromBusinessDate + ", Bus.Date To : " + toBusinessDate + ", Val.Date From : " + fromBusinessDate + ", Val.Date To : " + toBusinessDate + ", Session : " + winSess + ") | Result Count - " + colResult.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
        if (request.getParameter("hdnReqPageNo") != null)
        {
            reqPageNo = Integer.parseInt(request.getParameter("hdnReqPageNo"));
        }

        totalRecordCount = DAOFactory.getOWDetailsDAO().getRecordCountOWDetails(LCPL_Constants.status_all, LCPL_Constants.status_all, desBankCode, desBranchCode, originalBankCode, originalBranchCode, transCode, returnCode, winSess, fromBusinessDate, toBusinessDate, fromValueDate, toValueDate, fileId, desActNo, desActName, orgActNo, orgActName, status, minAmount, maxAmount);
...
<html>
    <head>
        <title>OUSDPS Web - Transaction Reports (Outward Details)</title>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            document.frmOWDetails.action="SearchOWDetails.jsp";
            document.frmOWDetails.submit();				
            return true;
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Transaction Inquiry (Outward Details)</td>
                                                                                      <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="10"></td>
                                                                                        <td align="center" valign="top" class="cits_header_text"><form id="frmOWDetails" name="frmOWDetails" method="post" >
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td align="center" valign="top" ><table border="0" cellspacing="1" cellpadding="3" >
                                                                                                                                    ...
                                                                                                                                    <select name="cmbBankOrginal" id="cmbBankOrginal" onChange="doSearch(0)" class="cits_field_border" <%=(userType.equals(LCPL_Constants.user_type_bank_user) || userType.equals(LCPL_Constants.user_type_settlement_bank_user)) ? "disabled" : ""%>>
                                                                                                                                        ...
                                                                                                                                        <%
                                                                                                                                            if (colBank != null && colBank.size() > 0)
                                                                                                                                            {
																																				...
																																				if (userType.equals(LCPL_Constants.user_type_bank_user) && (bank != null && (bank.getBankCode().equals(LCPL_Constants.LCPL_bank_code) || bank.getBankCode().equals(LCPL_Constants.Not_Available_bank_code))))
                                                                                                                                                    {
                                                                                                                                                    }
                                                                                                                                                    else
                                                                                                                                                    {
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" bgcolor="#DFEFDE"><%                                                                                                                                    try
                                                                                                                                    {
                                                                                                                                    %>
                                                                                                                                ...
                                                                                                                                <td align="left" bgcolor="#DFEFDE"> <table border="0" cellspacing="0" cellpadding="0">
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td width="2px"></td>
                                                                                                                                            <td><input name="txtDesActName" type="text" class="cits_field_border" id="txtDesActName" onFocus="clearResultData()" value="<%=(desActName != null) ? desActName : ""%>" size="28" maxlength="40"></td>
                                                                                                                                        </tr>
                                                                                                                                    </table>                                                                                                         </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE"><table border="0" cellspacing="0" cellpadding="0">
                                                                                                                                        <tr>
                                                                                                                                            <td valign="middle"><input name="txtFromBusinessDate" id="txtFromBusinessDate" type="text" onFocus="this.blur();
                                                                                                                                                    clearResultData()" class="tcal" size="11" value="<%=(fromBusinessDate == null || fromBusinessDate.equals("0") || fromBusinessDate.equals(LCPL_Constants.status_all)) ? "" : fromBusinessDate%>" >                                                                                                                    </td>
                                                                                                                                            <td width="5" valign="middle"></td>
                                                                                                                                            <td width="10" valign="middle"></td>
                                                                                                                                            <td valign="middle"><input name="txtToBusinessDate" id="txtToBusinessDate" type="text" onFocus="this.blur();
                                                                                                                                                    clearResultData()" class="tcal" size="11" value="<%=(toBusinessDate == null || toBusinessDate.equals("0") || toBusinessDate.equals(LCPL_Constants.status_all)) ? "" : toBusinessDate%>" onChange="clearResultData()">                                                                                                                    </td>
                                                                                                                                            <td width="5" valign="middle"></td>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" bgcolor="#DFEFDE" class="cits_tbl_header_text"><table border="0" cellspacing="0" cellpadding="0">
                                                                                                                                        <tr>
                                                                                                                                            <td valign="middle"><input name="txtFromValueDate" id="txtFromValueDate" type="text" onFocus="this.blur();
                                                                                                                                                    clearResultData()" class="tcal" size="11" value="<%=(fromValueDate == null || fromValueDate.equals("0") || fromValueDate.equals(LCPL_Constants.status_all)) ? "" : fromValueDate%>" >                                                                                                                    </td>
                                                                                                                                            <td width="5" valign="middle"></td>
                                                                                                                                            <td width="10" valign="middle"></td>
                                                                                                                                            <td valign="middle"><input name="txtToValueDate" id="txtToValueDate" type="text" onFocus="this.blur();
                                                                                                                                                    clearResultData()" class="tcal" size="11" value="<%=(toValueDate == null || toValueDate.equals("0") || toValueDate.equals(LCPL_Constants.status_all)) ? "" : toValueDate%>" onChange="clearResultData()">                                                                                                                    </td>
                                                                                                                                            <td width="5" valign="middle"></td>
                                                                                                                                            <td width="10px" valign="middle"></td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td align="center"><div id="resultdata">
                                                                                                                        ...
                                                                                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td align="right"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="cits_table_boder_print">
                                                                                                                                        <tr bgcolor="#DFE0E1">

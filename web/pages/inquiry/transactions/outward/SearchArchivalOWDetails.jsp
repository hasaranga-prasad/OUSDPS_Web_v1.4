...
<%
    ...
    else
    {
        ...
        if (!(userType.equals(LCPL_Constants.user_type_lcpl_super_user) || userType.equals(LCPL_Constants.user_type_bank_user)))
        {
            session.invalidate();
...
<html>
    <head>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            document.frmArchivalOWDetails.action="SearchArchivalOWDetails.jsp";
            document.frmArchivalOWDetails.submit();				
            return true;
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="10"></td>
                                                                                        <td align="center" valign="top" class="cits_header_text"><form id="frmArchivalOWDetails" name="frmArchivalOWDetails" method="post" >

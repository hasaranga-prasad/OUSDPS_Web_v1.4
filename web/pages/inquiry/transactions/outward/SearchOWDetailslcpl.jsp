...
<%
    ...
    else
    {
        ...
        if (!(userType.equals(LCPL_Constants.user_type_lcpl_super_user)||userType.equals(LCPL_Constants.user_type_lcpl_supervisor) || userType.equals(LCPL_Constants.user_type_lcpl_bcm_operator)))
        {
            session.invalidate();
...
<html>
    <head>
        <title>OUSDPS Web - Transaction Inquiry (Outward Details)</title>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            function doSearch(val)
            {
                if(val==0)
                {
                    ...
                    document.frmOWDetailsLCPL.action="SearchOWDetailslcpl.jsp";
                    document.frmOWDetailsLCPL.submit();				
                    return true;
                                        ...
                                        <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="10">&nbsp;</td>
                                                                <td align="left" valign="top" class="cits_header_text">Transaction Inquiry</td>
                                                                <td width="10">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td height="15"></td>
                                                            ...
                                                            <tr>
                                                                <td width="10"></td>
                                                                <td align="center" valign="top" class="cits_header_text"><form id="frmOWDetailsLCPL" name="frmOWDetailsLCPL" method="post" >

...
<%
    ...
    if (bankStatus != null)
    {
        ...
        String bankStatusDesc = bankStatus.equals(LCPL_Constants.status_active) ? "Active" : bankStatus.equals(LCPL_Constants.status_deactive) ? "Deactive" : bankStatus.equals(LCPL_Constants.status_all) ? "All" : "N/A";
        DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_bank_branch_maintenance_view_bank_details, "| Search Criteria - (Bank Status : " + bankStatusDesc + ") | Result Count - " + col_bank.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
    }
    else
    {
        col_bank = DAOFactory.getBankDAO().getBank(LCPL_Constants.status_all);
        DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_bank_branch_maintenance_view_bank_details, "| Search Criteria - (Bank Status : All) | Result Count - " + col_bank.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
    }
%>


<html>
    <head><title>OUSDPS Web - View Bank</title>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Bank Details</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="5"></td>
                                                                                                                ...
                                                                                                                <td align="center" valign="middle">
                                                                                                                    ...
                                                                                                                    <form name="frmBankFilter" method="post" action="ViewBank.jsp">
                                                                                                                        ...
                                                                                                                        <table  border="0" cellspacing="1" cellpadding="3" class="cits_table_boder" bgcolor="#FFFFFF" align="center">
                                                                                                                            <tr>
                                                                                                                                <td width="80" align="right" valign="middle" bgcolor="#B3D5C0" class="cits_common_text_bold"> Bank Status</td>
                                                                                                                                <td width="" align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text_bold"><table  border="0" cellpadding="0" cellspacing="0" >
                                                                                                                                        <tr>
                                                                                                                                            <td><input type="radio" name="rbStatus" value="<%=LCPL_Constants.status_all%>" id="rbAll" onClick="frmBankFilter.submit()" <%=(bankStatus == null || (bankStatus != null && bankStatus.equals(LCPL_Constants.status_all))) ? "checked" : ""%>></td>
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td class="cits_common_text_bold">All</td>
                                                                                                                                            <td width="15"></td>
                                                                                                                                            <td><input type="radio" name="rbStatus" value="<%=LCPL_Constants.status_active%>" id="rbActive" onClick="frmBankFilter.submit()" <%=(bankStatus != null && bankStatus.equals(LCPL_Constants.status_active)) ? "checked" : ""%>></td>
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td class="cits_common_text_bold">Active</td>
                                                                                                                                            <td width="15"></td>
                                                                                                                                            <td><input type="radio" name="rbStatus" value="<%=LCPL_Constants.status_deactive%>" id="rbDeactive" onClick="frmBankFilter.submit()" <%=(bankStatus != null && bankStatus.equals(LCPL_Constants.status_deactive)) ? "checked" : ""%>></td>
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td class="cits_common_text_bold">Inactive</td>
                                                                                                                                            <td width="15"></td>
                                                                                                                                            <td><input type="radio" name="rbStatus" value="<%=LCPL_Constants.status_pending%>" id="rbPending" onClick="frmBankFilter.submit()" <%=(bankStatus != null && bankStatus.equals(LCPL_Constants.status_pending)) ? "checked" : ""%>></td>
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td class="cits_common_text_bold">Pending</td>
                                                                                                                                        </tr>
                                                                                                                                    </table>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                    ...
                                                                                                    <td align="center" valign="middle">
                                                                                                        <table border="0" cellspacing="1" cellpadding="3" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td align="center" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Bank Code</td>
                                                                                                                <td align="center" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Short Name</td>
                                                                                                                <td align="center" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Full Name</td>
                                                                                                            ...
                                                                                                            <%
                                                                                                                ...
                                                                                                                for (Bank b : col_bank)
                                                                                                                {
                                                                                                                    if (userType.equals(LCPL_Constants.user_type_bank_user) && (b != null && (b.getBankCode().equals(LCPL_Constants.LCPL_bank_code) || b.getBankCode().equals(LCPL_Constants.Not_Available_bank_code) )))
                                                                                                                    {}
                                                                                                                    else
                                                                                                                    {
                                                                                                            ...
                                                                                                            <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>" onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                ...
                                                                                                                <td align="center" class="cits_common_text"><%=b.getBankCode() != null ? b.getBankCode() : "N/A"%></td>
                                                                                                                <td align="center" class="cits_common_text"><%=b.getShortName() != null ? b.getShortName() : "N/A"%></td>
                                                                                                                <td align="left" class="cits_common_text"><%=b.getBankFullName() != null ? b.getBankFullName() : "N/A"%></td>

...
<%@page import="lk.com.ttsl.ousdps.dao.rejectreason.*" errorPage="../../../error.jsp"%>
...
<%
    Collection<RejectReason> col = DAOFactory.getRejectReasonDAO().getRejectReasons();
    DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_user_inquiry_view_return_types, "| Search Criteria - (All) | Result Count - " + col.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));        
%>
...
<tr>
                  ...
                  <tr>
                                                    ...
                                                    <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="10">&nbsp;</td>
                                                                <td align="left" valign="top" class="cits_header_text">Reject Reasons</td>
                                                                <td width="10">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td height="20"></td>
                                                                        ...
                                                                        <tr><td>
                                                                                ...
                                                                                <table border="0" cellspacing="0" cellpadding="0" class="cits_table_boder"><tr><td>
                                                                                          ...
                                                                                          <tr>
                                                                                                    ...
                                                                                                    <td align="center" bgcolor="#B3D5C0" class="cits_tbl_header_text">Reject<br/>Code</td>
                                                                                          </tr>


                                                                                                <% for (RejectReason rejectReason : col)
                                                                                                    {
                                                                                                        rowNum++;
                                                                                                %>
                                                                                                <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>"  onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                    ...
                                                                                                    <td align="left" class="cits_common_text"><%=rejectReason.getRejectReason() %></td>
                                                                                                    <!--td align="left" class="cits_common_text"><%=rejectReason.getHtmlDescription() %></td-->
                                                                                                    <td align="center" class="cits_common_text_bold"><%=rejectReason.getRejectCode() %></td>
                                                                                                </tr>

...
<%
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        String statusDesc = status.equals(LCPL_Constants.status_active) ? "Active" : status.equals(LCPL_Constants.status_deactive) ? "Deactive" : status.equals(LCPL_Constants.status_all) ? "All" : "N/A";
        DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_bank_branch_maintenance_view_branch_details, "| Search Criteria - (Bank Code : " + bankCode + " Status : " + statusDesc + ") | Result Count - " + colResult.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
    }
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" >
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text"> Branch Details</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                                                    ...
                                                                                                                    <td><table border="0" align="center" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE">
                                                                                                                                    <select name="cmbBank" id="cmbBank" class="cits_field_border" onChange="clearResultData();">
                                                                                                                                        <%
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE">
                                                                                                                                    <select name="cmbStatus" id="cmbStatus" class="cits_field_border" onChange="clearResultData()">
                                                                                                                                        ...
                                                                                                                                        <option value="<%=LCPL_Constants.status_pending%>" <%=status != null && status.equals(LCPL_Constants.status_pending) ? "selected" : ""%>>Pending</option>
                                                                                                                                    </select></td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td colspan="2" align="right" bgcolor="#CDCDCD"><table cellpadding="0" cellspacing="0" border="0">
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td align="right"><input name="btnSearch" id="btnSearch" value="Search" type="button" onClick="isSearchRequest(true);
                                                                                                                                                    frmViewBranch.submit()"  class="cits_custom_button"/></td>
                                                                                                                                        </tr>
                                                                                                                                    </table></td>
                                                                                                                            </tr>
                                                                                                                        </table></td>
                                                                                                                ...
                                                                                                                <td><div id="resultdata">
                                                                                                                        <table  border="0" cellspacing="1" cellpadding="3" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="center" bgcolor="#B3D5C0" class="cits_tbl_header_text">Branch Code</td>
                                                                                                                                <td align="center" bgcolor="#B3D5C0" class="cits_tbl_header_text">Branch Name</td>
                                                                                                                            ...
                                                                                                                            <%
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    if (userType.equals(LCPL_Constants.user_type_bank_user) && (branch != null && (branch.getBankCode().equals(LCPL_Constants.LCPL_bank_code) || branch.getBankCode().equals(LCPL_Constants.Not_Available_bank_code))))
                                                                                                                                    {
                                                                                                                                    }
                                                                                                                                    else
                                                                                                                                    {
                                                                                                                            ...
                                                                                                                            <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>"  onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                                ...
                                                                                                                                <td align="center"  class="cits_common_text"><span class="cits_common_text" title="<%=branch.getBankFullName()%>"><%=branch.getBankCode() + " - " + branch.getBankShortName()%></span></td>
                                                                                                                                <td align="center"  class="cits_common_text"><%=branch.getBranchCode()%></td>
                                                                                                                                <td align="center"  class="cits_common_text"><%=branch.getBranchName()%></td>
                                                                                                                                <td align="center"  class="cits_common_text"><%=branch.getStatus() != null ? branch.getStatus().equals(LCPL_Constants.status_active) ? "Active" : branch.getStatus().equals(LCPL_Constants.status_pending) ? "Pending" : "Inactive" : "N/A"%></td>
                                                                                                                            </tr>

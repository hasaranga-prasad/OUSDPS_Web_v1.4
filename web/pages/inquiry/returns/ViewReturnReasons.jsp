...
<tr>
                  ...
                  <tr>
                                                    ...
                                                    <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="10">&nbsp;</td>
                                                                <td align="left" valign="top" class="cits_header_text"> Return Types</td>
                                                                <td width="10">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td height="20"></td>
                                                                                ...
                                                                                <table border="0" cellspacing="0" cellpadding="0" class="cits_table_boder"><tr><td>
                                                                                          ...
                                                                                          <tr>
                                                                                                ...
                                                                                                <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>"  onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                    ...
                                                                                                    <td align="center" class="cits_common_text"><%=returnReason.getReturnCode() %></td>
                                                                                                    <td align="left" class="cits_common_text"><%=returnReason.getReturnReason() %></td>
                                                                                                    <% 
																												if(!(userType.equals(LCPL_Constants.user_type_settlement_bank_user)|| userType.equals(LCPL_Constants.user_type_bank_user)))
																												{
																												%><td align="left" class="cits_common_text"><%=returnReason.getPrintAS() %></td><%}%>
                                                                                                </tr>

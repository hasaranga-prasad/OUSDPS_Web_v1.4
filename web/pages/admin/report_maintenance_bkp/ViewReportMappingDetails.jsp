...
<%
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_reportmap_maintenance_view_reportmap_details, "| Search Criteria - (Source Bank  : " + srcBankCode + ", Destination Bank : " + desBankCode + ", Session : " + selSession + ", Status : " + selStatusDesc + ") | Result Count - " + colReportMap.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
    }
...
<html>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" class="cits_body" onLoad="showClock(3)">
        <table style="min-width:980" height="600" align="center" border="0" cellpadding="0" cellspacing="0" >
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%" height="16" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">View Report Mapping Details</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="10"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" valign="top" class="cits_header_text">
                                                                                            <form id="frmViewRMP" name="frmViewRMP" method="post" action="ViewReportMappingDetails.jsp" >
            ...
            frmViewRMP.submit()"  class="cits_custom_button"/></td>
                                                                                                                            </tr></table></td>
                                                                                                                </tr>
                                                                                                            </table></td>
                                                                                                </table>
                                                                                                    ...
                                                                                                    <div id="resultdata">
                                                                                                        <table border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="cits_table_boder">
                                                                                                            ...
                                                                                                            <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>"  onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                ...
                                                                                                                <td align="center" class="cits_common_text"><span class="cits_common_text" title="<%=rmap.getSrcBankFullName()%>"><%=rmap.getSrcBankCode()%> - <%=rmap.getSrcBankShortName()%></span></td>
                                                                                                                <td class="cits_common_text"><%=rmap.getSrcFileName() %></td>
                                                                                                              <td align="center" class="cits_common_text"><span class="cits_common_text" title="<%=rmap.getDesBankFullName()%>"><%=rmap.getDesBankCode()%> - <%=rmap.getDesBankShortName()%></span></td>
                                                                                                                <td class="cits_common_text"><%=rmap.getDesFileName() %></td>
                                                                                                              <td align="center" class="cits_common_text"><%=rmap.getSession()%></td>
                                                                                                                <td align="center" class="cits_common_text"><%=rmap.getStatus()!=null?rmap.getStatus().equals(LCPL_Constants.status_active)?"Active":"Inactive":"-" %></td>

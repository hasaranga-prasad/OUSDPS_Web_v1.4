...
<%
    ...
    String pcStatus = (String) request.getParameter("rbStatus");

    Collection<PurposeCode> col_pc = null;

    if (pcStatus != null)
    {
        col_pc = DAOFactory.getPurposeCodeDAO().getPurposeCodesDetails(pcStatus);
        String pcStatusDesc = pcStatus.equals(LCPL_Constants.status_active) ? "Active" : pcStatus.equals(LCPL_Constants.status_deactive) ? "Deactive" : pcStatus.equals(LCPL_Constants.status_all) ? "All" : "N/A";
        DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_purposecode_maintenance_view_purpose_code, "| Search Criteria - (Status : " + pcStatusDesc + ") | Result Count - " + col_pc.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
    }
    else
    {
        col_pc = DAOFactory.getPurposeCodeDAO().getPurposeCodesDetails(LCPL_Constants.status_all);
        DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_purposecode_maintenance_view_purpose_code, "| Search Criteria - (Status : All) | Result Count - " + col_pc.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
    }
%>


<html>
    <head><title>OUSDPS Web - View Purpose Code(s)</title>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">View Purpose Code(s)</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="5"></td>
                                                                                                    ...
                                                                                                    <td height="15" align="center" valign="middle"><table border="0" cellspacing="0" cellpadding="0" align="center">
                                                                                                            <tr>
                                                                                                                <td align="center" valign="middle">
                                                                                                                    ...
                                                                                                                    <form name="frmViewBankPC" method="post" action="ViewPurposeCode.jsp">
                                                                                                      ...
                                                                                                      <td width="" align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text_bold"><table  border="0" cellpadding="0" cellspacing="0" >
                                                                                                                                        <tr>
                                                                                                                                            <td><input type="radio" name="rbStatus" value="<%=LCPL_Constants.status_all%>" id="rbAll" onClick="frmViewBankPC.submit()" <%=(pcStatus == null || (pcStatus != null && pcStatus.equals(LCPL_Constants.status_all))) ? "checked" : ""%>></td>
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td class="cits_common_text_bold">All</td>
                                                                                                                                            <td width="15"></td>
                                                                                                                                            <td><input type="radio" name="rbStatus" value="<%=LCPL_Constants.status_active%>" id="rbActive" onClick="frmViewBankPC.submit()" <%=(pcStatus != null && pcStatus.equals(LCPL_Constants.status_active)) ? "checked" : ""%>></td>
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td class="cits_common_text_bold">Active</td>
                                                                                                                                            <td width="15"></td>
                                                                                                                                            <td><input type="radio" name="rbStatus" value="<%=LCPL_Constants.status_deactive%>" id="rbDeactive" onClick="frmViewBankPC.submit()" <%=(pcStatus != null && pcStatus.equals(LCPL_Constants.status_deactive)) ? "checked" : ""%>></td>
                                                                                                                                            <td width="5"></td>
                                                                                                    ...
                                                                                                    <td align="center" valign="middle">
                                                                                                        <table border="0" cellspacing="1" cellpadding="3" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td align="center" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Purpose<br>Code</td>
                                                                                                                <td align="center" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Description</td>
                                                                                                            ...
                                                                                                            <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>" onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                ...
                                                                                                                <td align="center" class="cits_common_text"><%=b.getPurposeCode() != null ? b.getPurposeCode() : "N/A"%></td>
                                                                                                                <td align="left" class="cits_common_text"><%=b.getDesc() != null ? b.getDesc() : "N/A"%></td>

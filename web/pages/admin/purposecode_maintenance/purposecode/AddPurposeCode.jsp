...
<%
    ...
    {
        purposeCode = request.getParameter("txtPurposeCode");
        desc = request.getParameter("txtDesc");
        status = request.getParameter("cmbStatus");

        PurposeCodeDAO purDAO = DAOFactory.getPurposeCodeDAO();

        result = purDAO.addPurposeCode(new PurposeCode(purposeCode, desc, status, userName));

        if (!result)
        {
            msg = purDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_purposecode_maintenance_add_purpose_code, "| Purpose Code - " + purposeCode  + ", Description - " + desc + ", Status - " + status + " | Process Status - Unsuccess (" + msg + ") | Added By - " + userName + " (" + userTypeDesc + ") |"));
        }
        else
        {
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_purposecode_maintenance_add_purpose_code, "| Purpose Code - " + purposeCode  + ", Description - " + desc + ", Status - " + status + " | Process Status - Success | Added By - " + userName + " (" + userTypeDesc + ") |"));
        }
    }
...
<html>
    <head><title>OUSDPS Web - Add Purpose Code</title>
        ...
        {
            document.getElementById('txtPurposeCode').setAttribute("autocomplete","off");
        ...
        {
            document.getElementById('txtPurposeCode').value="";
        ...
        {
            var purcode = document.getElementById('txtPurposeCode').value;
            ...
            if(isempty(purcode))
            {
                alert("Purpose Code Can't be Empty");
                document.getElementById('txtPurposeCode').focus();
                return false;
            }
            else if (!numbers.test(purcode)) 
            {
                alert("Purpose Code must contain numbers only!");
				document.getElementById('txtPurposeCode').focus();
                return false;
            }
            else if(purcode.length!=4)
            {
                alert("Purpose Code should contain only 4 digits!");
                document.getElementById('txtPurposeCode').focus();
                return false;
            }
		   ...
		   if(stat==null || stat=="-1")
            ...
            document.frmAddPurposeCode.action="AddPurposeCode.jsp";
            document.frmAddPurposeCode.submit();
        }
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%" height="16" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Add Purpose Code(s)</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="20"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top">
                                                                                            <form method="post" name="frmAddPurposeCode" id="frmAddPurposeCode">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="center">
                                                                                                            ...
                                                                                                            <div id="displayMsg_success" class="cits_Display_Success_msg" >
                                                                                                                ...
                                                                                                                Purpose Code Added Sucessfully.
                                                                                                            ...
                                                                                                            <div id="displayMsg_error" class="cits_Display_Error_msg" >Purpose Code Adding Failed. - <span class="cits_error"><%=msg%></span></div>
                                                                                                                <%                                                                                            }
                                                                                                                %>
...
<td width="185" valign="middle" bgcolor="#DFEFDE" class="cits_tbl_header_text">
                                                              ...
                                                              <input name="txtPurposeCode" type="text" class="cits_field_border" id="txtPurposeCode" onFocus="hideMessage_onFocus()"  value="<%=purposeCode != null ? purposeCode : ""%>" size="4" maxlength="4"/></td>
                                                                                                                      </tr>
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td bgcolor="#DFEFDE" valign="middle" class="cits_tbl_header_text">
                                                                                                                                    <input name="txtDesc" type="text" class="cits_field_border" id="txtDesc" onFocus="hideMessage_onFocus()"
                                                                                                                                           value="<%=desc != null ? desc : ""%>" size="100" maxlength="150"/>          </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                              <td bgcolor="#B3D5C0" valign="middle" class="cits_tbl_header_text">

...
<%
    ...
    else if (reqType.equals("0"))
    {
        ...
        {
            colBranch = DAOFactory.getBranchDAO().getAuthPendingBranches(cmbBankCode, userName);
    ...
    else if (reqType.equals("1"))
    {
        ...
        result = branchDAO.doAuthorizedBranch(new Branch(bankCode, branchCode, userName));

        if (!result)
        {
            msg = branchDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_bank_branch_maintenance_authorized_new_branch, "| Bank Code - " + bankCode + ", Branch Code - " + branchCode + ", Branch Name - " + branchName + ", Branch Status - " + branchDetails.getStatus() + " | Process Status - Unsuccess (" + msg + ") | Modified By - " + userName + " (" + userTypeDesc + ") |"));
        }
        else
        {
            branchDetails.setStatus(LCPL_Constants.status_active);
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_bank_branch_maintenance_authorized_new_branch, "| Bank Code - " + bankCode + ", Branch Code - " + branchCode + ", Branch Name - " + branchName + ", Branch Status - " + branchDetails.getStatus() + " | Process Status - Success | Modified By - " + userName + " (" + userTypeDesc + ") |"));
        }
    }
%>
<html>
    <head><title>OUSDPS Web - Authorize New Branch(es)</title>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" >
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Authorize New Branch(es)</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="5"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td height="5"></td>
                                                                                        <td align="center" valign="top" class="cits_header_text"><form name="frmAuthNewBranch" id="frmAuthNewBranch" method="post" >
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="center" valign="middle"><table border="0" align="center" cellspacing="1" cellpadding="3" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" valign="middle" bgcolor="#DFEFDE">
                                                                                                                        <select name="cmbBranch" id="cmbBranch" class="cits_field_border" onChange="doSearchBranch();">
                                                                                                                    ...
                                                                                                                    <td><div id="resultdata"><table border="0" cellspacing="0" cellpadding="0">
                                                                                                                                <tr>
                                                                                                                                    <td align="center">
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_error" class="cits_Display_Error_msg" >Branch Approval Failed.- <span class="cits_error"><%=msg%></span></div>
                                                                                                                                            <%                                                                                            }
                                                                                                                                            %>
                                                                                                                                    ...
                                                                                                                                    <td align="center" valign="middle">
                                                                                                                                        ...
                                                                                                                                        <table border="0" cellspacing="1" cellpadding="5" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text"><%=branchDetails.getBankCode()%> <input type="hidden" name="txtBankCode" id="txtBankCode" class="cits_success" value="<%=branchDetails.getBankCode()%>" />                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#B3D5C0" class="cits_common_text_bold">Branch Code : </td>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text"><%=branchDetails.getBranchCode()%><input type="hidden" name="txtBranchCode" id="txtBranchCode" class="cits_success" value="<%=branchDetails.getBranchCode()%>" /></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#B3D5C0" class="cits_common_text_bold">Branch Name :</td>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text"><%=branchDetails.getBranchName()%><input name="txtBranchName" type="hidden" class="cits_field_border" id="txtBranchName" size="50" value="<%=branchName != null ? branchName : ""%>"/>                                                                              </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text">
                                                                                                                                                    <%
                                                                                                                                                        ...
                                                                                                                                                        else if (branchDetails.getStatus().equals(LCPL_Constants.status_pending))
                                                                                                                                                        {
                                                                                                                                            ...
                                                                                                                                            <tr>  <td height="35" colspan="2" align="right" bgcolor="#CDCDCD" class="cits_common_text_bold">
                                                                                                                                                    ...
                                                                                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                                                        <tr>
                                                                                                                                                            ...
                                                                                                                                                            <td width="5"></td>
                                                                                                                                                            <td><input name="btnClear" id="btnClear"  value="<%=(reqType.equals("1")&&result==true)?"OK":"Cancel"%>" type="button" class="cits_custom_button" onClick="setRequestType(false);document.frmAuthNewBranch.action='<%=(reqType.equals("1")&&result==true)?"AuthNewBranch.jsp":request.getContextPath()+"/pages/homepage.jsp"%>';<%=(reqType.equals("1")&&result==true)?"document.getElementById('cmbBank').selectedIndex=0;":""%><%=(reqType.equals("1")&&result==true)?"document.getElementById('cmbBranch').selectedIndex=0;":""%>document.frmAuthNewBranch.submit()"/>                                                            </td></tr>
                                                                                                                                                    </table>

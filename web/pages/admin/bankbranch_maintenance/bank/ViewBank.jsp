                                                                                                    ...
                                                                                                    <td align="center" valign="middle">
                                                                                                        <table border="0" cellspacing="1" cellpadding="3" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td align="center" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Account No.</td>
                                                                                                            ...
                                                                                                            <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>" onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                ...
                                                                                                                <td align="center" class="cits_common_text"><%=b.getAccNo() != null ? b.getAccNo() : "N/A"%></td>

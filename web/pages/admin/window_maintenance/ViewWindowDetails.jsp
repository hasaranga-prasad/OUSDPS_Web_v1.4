...
<%
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        colWindow = DAOFactory.getWindowDAO().getWindowDetails(bankCode, winSess);
        DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_window_maintenance_view_window_details, "| Search Criteria - (Bank  : " + bankCode + ", Session : " + winSess + ") | Result Count - " + colWindow.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
    }
...
<html>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" class="cits_body" onLoad="showClock(3)">
        <table style="min-width:980" height="600" align="center" border="0" cellpadding="0" cellspacing="0" >
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" valign="top" class="cits_header_text">
                                                                                            <form id="frmViewWindow" name="frmViewWindow" method="post" action="ViewWindowDetails.jsp" >
            ...
            frmViewWindow.submit()"  class="cits_custom_button"/></td>
                                                                                                                            </tr></table></td>
                                                                                                                </tr>
                                                                                                            </table></td>
                                                                                                </table>

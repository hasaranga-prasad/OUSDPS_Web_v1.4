...
<%
    ...
    else
    {
        ...
        if (!(userType.equals(LCPL_Constants.user_type_lcpl_super_user) || userType.equals(LCPL_Constants.user_type_lcpl_supervisor) || userType.equals(LCPL_Constants.user_type_lcpl_administrator) || userType.equals(LCPL_Constants.user_type_lcpl_bcm_operator) || userType.equals(LCPL_Constants.user_type_lcpl_helpdesk_user)))
        {
            session.invalidate();
...
<%
    Collection<ReturnReason> col = DAOFactory.getReturnReasonDAO().getReTurnTypes();
    DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_return_maintenance_view_return_types, "| Search Criteria - (All) | Result Count - " + col.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
%>


<html>
    <head><title>OUSDPS Web - View Return Reasons</title>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%" height="16" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text"> View Return Types</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="20"></td>
                                                                                                        ...
                                                                                                        <table border="0" cellspacing="0" cellpadding="0" class="cits_table_boder"><tr><td>
                                                                                                                    ...
                                                                                                                    <table border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF">
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td align="center" bgcolor="#B3D5C0" class="cits_tbl_header_text">Return Code</td>
                                                                                                                            <td align="center" bgcolor="#B3D5C0" class="cits_tbl_header_text"> Reason</td>
                                                                                                                            <td align="center" bgcolor="#B3D5C0" class="cits_tbl_header_text">Print As</td>
                                                                                                                            <td align="center" bgcolor="#B3D5C0" class="cits_tbl_header_text">Status</td>
                                                                                                                        </tr>


                                                                                                                        <% for (ReturnReason returnReason : col)
                                                                                                                            {
                                                                                                                                rowNum++;
                                                                                                                        %>
                                                                                                                        <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>"  onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                            ...
                                                                                                                            <td align="center" class="cits_common_text_bold"><%=returnReason.getReturnCode()%></td>
                                                                                                                            <td align="left" class="cits_common_text"><%=returnReason.getReturnReason()!=null?returnReason.getReturnReason():""%></td>
                                                                                                                            <td align="left" class="cits_common_text"><%=returnReason.getPrintAS()!=null?returnReason.getPrintAS():""%></td>
                                                                                                                            <td align="left" class="cits_common_text"><%=returnReason.getStatus()!=null?returnReason.getStatus():""%></td>
                                                                                                                        </tr>

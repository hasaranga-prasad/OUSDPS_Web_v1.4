...
<%
    ...
    if (isReq == null)
    {
        ...
        col_user = DAOFactory.getUserDAO().getUsers(new User(newUserLevel, newUserBank, newUserBranch, newUserStatus), LCPL_Constants.status_active);
    }
    else if (isReq.equals("0"))
    {
        ...
        if (newUserLevel != null && (newUserLevel.equals(LCPL_Constants.user_type_settlement_bank_user) || newUserLevel.equals(LCPL_Constants.user_type_bank_user) || newUserLevel.equals(LCPL_Constants.status_all)))
        {
    ...
    else if (isReq.equals("1"))
    {
        ...
        result = userDAO.setUserStatus(selectedUserId, LCPL_Constants.status_active);
        ...
        {
            msg = userDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_user_maintenance_activate_user, "| User Name - " + selectedUserId + ", Status - (New : Active, Old : " + currentUserStat + ") | Process Status - Unsuccess (" + msg + ") | Modified By - " + userName + " (" + userTypeDesc + ") |"));
        }
        else
        {
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_user_maintenance_activate_user, "| User Name - " + selectedUserId + ", Status - (New : Active, Old : " + currentUserStat + ") | Process Status - Success | Modified By - " + userName + " (" + userTypeDesc + ") |"));
        }
    }
%>
...
<head>
    ...
    <title>OUSDPS Web - Activate User</title>
    ...
    <script language="javascript" type="text/JavaScript">
        ...
        if(selUser == "-1")
        {
        alert("You must select valid user name for Activation!");
        document.getElementById('cmbUserId').focus();
        return false;
        }
        else
        {
        document.frmActivateUser.submit();
        }
        }
    ...
    <table style="min-width:980" height="600" align="center" border="0" cellpadding="0" cellspacing="0" >
        <tr>
            <td align="center" valign="top" class="cits_bgRepeat_center">
                                                            ...
                                                            <td align="center" valign="middle"><table width="100%" height="16" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="10">&nbsp;</td>
                                                                                    <td align="left" valign="top" class="cits_header_text">Activate User</td>
                                                                                    <td width="10">&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="20"></td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="center" valign="top" class="cits_header_text">
                                                                                        ...
                                                                                        <form id="frmActivateUser" name="frmActivateUser" action="UserActivation.jsp">
                                                                                            ...
                                                                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                                ...
                                                                                                <%
                                                                                                    ...
                                                                                                    {%>
                                                                                                <tr>
                                                                                                    <td align="center" ><div id="displayMsg_success" class="cits_Display_Success_msg" >User Activate Succesfully.</div></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td height="5" ></td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="center" class="cits_Display_Error_msg"><div id="displayMsg_error" class="cits_Display_Error_msg" >User Activation Faile - <span class="cits_error"><%=msg%></span></div></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td height="5" ></td>
                                                                                                </tr>
                ...
                frmActivateUser.submit()" onFocus="hideMessage_onFocus()">
        ...
        frmActivateUser.submit()" onFocus="hideMessage_onFocus()" style="visibility:hidden;width:5px">
                                                                                                                                    <%
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td align="right" valign="bottom" bgcolor="#CDCDCD"class="cits_tbl_header_text"><table border="0" cellpadding="0" cellspacing="0">
                                                                                                                                    <tr>
                                                                                                                                        <td><input type="button" value="Activate" name="btnChange" id="btnChange" class="cits_custom_button" onClick="isRequest(true);
        validate();"/>                             </td>
                                                                                                                                        <td width="5"></td>
                                                                                                                                        <td><input name="btnClear" id="btnClear" value="Reset" type="reset"  class="cits_custom_button" />                                                </td></tr>
                                                                                                                                </table></td>
                                                                                                                        </tr>

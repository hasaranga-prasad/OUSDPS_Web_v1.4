...
<%
    ...
    {
        purposeCode = request.getParameter("txtAccCode");
        accType = request.getParameter("txtAccType");
        status = request.getParameter("cmbStatus");

        AccountTypeDAO actDAO = DAOFactory.getAccountTypeDAO();

        result = actDAO.addAccountType(new AccountType(purposeCode, accType, status, userName));

        if (!result)
        {
            msg = actDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_accounttype_maintenance_add_account_type, "| Account Code - " + purposeCode  + ", Account Type - " + accType + ", Status - " + status + " | Process Status - Unsuccess (" + msg + ") | Added By - " + userName + " (" + userTypeDesc + ") |"));
        }
        else
        {
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_accounttype_maintenance_add_account_type, "| Account Code - " + purposeCode  + ", Account Type - " + accType + ", Status - " + status + " | Process Status - Success | Added By - " + userName + " (" + userTypeDesc + ") |"));
        }
    }
...
<html>
    <head><title>OUSDPS Web - Add Account Type</title>
        ...
        {
            document.getElementById('txtAccCode').setAttribute("autocomplete","off");
            document.getElementById('txtAccType').setAttribute("autocomplete","off");
        ...
        {
            var acccode = document.getElementById('txtAccCode').value;
            var acctype = document.getElementById('txtAccType').value;
            ...
            if(isempty(acccode))
            {
                alert("Account Code Can't be Empty");
                document.getElementById('txtAccCode').focus();
                return false;
            }
            else if (!numbers.test(acccode)) 
            {
                alert("Account Code should contain numbers only!");
				document.getElementById('txtAccCode').focus();
                return false;
            }
            else if(acccode.length!=2)
            {
                alert("Account Code must contain 2 digits!");
                document.getElementById('txtAccCode').focus();
                return false;
            }
		   ...
		   if(stat==null || stat=="-1")
            ...
            document.frmAddAccountType.action="AddAccountType.jsp";
            document.frmAddAccountType.submit();
        }
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%" height="16" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Add Account Type</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="20"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top">
                                                                                            <form method="post" name="frmAddAccountType" id="frmAddAccountType">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="center">
                                                                                                            ...
                                                                                                            <div id="displayMsg_success" class="cits_Display_Success_msg" >
                                                                                                                ...
                                                                                                                Account Type Added Sucessfully.
                                                                                                            ...
                                                                                                            <div id="displayMsg_error" class="cits_Display_Error_msg" >Account Type Adding Failed. - <span class="cits_error"><%=msg%></span></div>
                                                                                                                <%                                                                                            }
                                                                                                                %>
                                                                                                                    ...
                                                                                                                    <td><table border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" >
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td width="126" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">
                                                                                                                                    Account Code <span class="cits_required_field">*</span> :        </td>

<td width="185" valign="middle" bgcolor="#DFEFDE" class="cits_tbl_header_text">

                                                              <input name="txtAccCode" type="text" class="cits_field_border" id="txtAccCode" onFocus="hideMessage_onFocus()"  value="<%=purposeCode != null ? purposeCode : ""%>" size="3" maxlength="2"/></td>
                                                                                                                      </tr>
                                                                                                                            <tr>
                                                                                                                                <td bgcolor="#B3D5C0" valign="middle" class="cits_tbl_header_text">
                                                                                                                                    Account Type <span  class="cits_required_field">* </span>:</td>
                                                                                                                                <td bgcolor="#DFEFDE" valign="middle" class="cits_tbl_header_text">
                                                                                                                                    <input name="txtAccType" type="text" class="cits_field_border" id="txtAccType" onFocus="hideMessage_onFocus()"
                                                                                                                                           value="<%=accType != null ? accType : ""%>" size="30" maxlength="30"/>          </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                              <td bgcolor="#B3D5C0" valign="middle" class="cits_tbl_header_text">

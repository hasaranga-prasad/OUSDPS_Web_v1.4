...
<%@page import="lk.com.ttsl.ousdps.dao.accounttype.*" errorPage="../../../error.jsp" %>
...
<%
    Collection<AccountType> colACT = null;
    AccountType actDetails = null;
    String reqType = null;
    String cmbACT = null;
    String actCode = null;
    String actType = null;
    ...
    colACT = DAOFactory.getAccountTypeDAO().getAccountTypeDetails(LCPL_Constants.status_all);
    ...
    else if (reqType.equals("0"))
    {
        ...
        actDetails = DAOFactory.getAccountTypeDAO().getAccountType(cmbACT);

        actCode = actDetails.getAccountCode();
        actType = actDetails.getAccountType();
        status = actDetails.getStatus();
    }
    else if (reqType.equals("1"))
    {
        ...
        actCode = (String) request.getParameter("hdnAccCode");
        actType = (String) request.getParameter("txtAccType");
        status = (String) request.getParameter("cmbStatus");

        AccountTypeDAO pcDAO = DAOFactory.getAccountTypeDAO();

        result = pcDAO.modifyAccountType(new AccountType(actCode, actType, status, userName));

        if (!result)
        {
            msg = pcDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_accounttype_maintenance_modify_account_type, "| Account Code - " + actCode + "), Account Type - (New :" + actType + ", Old : " + actDetails.getAccountType() + "), Status - (New : " + status + ", Old : " + actDetails.getStatus() + ") | Process Status - Unsuccess (" + msg + ") | Modified By - " + userName + " (" + userTypeDesc + ") |"));
        }
        else
        {
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_accounttype_maintenance_modify_account_type, "| Account Code - " + actCode + "), Account Type - (New :" + actType + ", Old : " + actDetails.getAccountType() + "), Status - (New : " + status + ", Old : " + actDetails.getStatus() + ") | Process Status - Success | Modified By - " + userName + " (" + userTypeDesc + ") |"));
        }
    }
%>
<html>
    <head><title>OUSDPS Web - Modify Account Type</title>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            {                
                document.getElementById('txtAccType').value = "";				
            ...
            {                
                ...
                var description = document.getElementById('txtAccType').value;
                ...
                {
                    alert("Select Account Type Status !");
                    document.getElementById('cmbStatus').focus();
                    return false;
                }

                document.frmModifyAccType.action="ModifyAccountType.jsp";
                document.frmModifyAccType.submit();
                return true;   
            }			
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" >
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Modify Account Type</td>
                                                                                      <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="5"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top" class="cits_header_text">
                                                                                            <form name="frmModifyAccType" id="frmModifyAccType" method="post" >
                                                                                                ...
                                                                                                <table border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        <td align="center" valign="middle"><table border="0" align="center" cellspacing="1" cellpadding="5" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                                <tr>
                                                                                                                    <td align="right" valign="middle" bgcolor="#B3D5C0" class="cits_common_text_bold">Accout Code :</td>
                                                                                                                    <td align="left" valign="middle" bgcolor="#DFEFDE">
                                                                                                                        <select name="cmbActCode" id="cmbActCode" class="cits_field_border" onChange="setRequestType(false);
                                                                                                                            ...
                                                                                                                            <option value="-1" <%=(cmbACT == null || cmbACT.equals("-1")) ? "selected" : ""%>>-- Select Account Type --</option>

                                                                                                                            <%
                                                                                                                                if (colACT != null && !colACT.isEmpty())
                                                                                                                                {

                                                                                                                                    for (AccountType pc : colACT)
                                                                                                                                    {
                                                                                                                            %>
                                                                                                                            <option value="<%=pc.getAccountCode()%>" <%=(cmbACT != null && pc.getAccountCode().equals(cmbACT)) ? "selected" : ""%>><%=pc.getAccountCode()%> - <%=pc.getAccountType() %></option>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td align="center">
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_success" class="cits_Display_Success_msg" >
                                                                                                                                            ...
                                                                                                                                            Account Type Modified Sucessfully.                                                                                                </div>
                                                                                                                                            <% }
                                                                                                                                            else
                                                                                                                                            {%>


                                                                                                                                        <div id="displayMsg_error" class="cits_Display_Error_msg" >Account Type Modification Failed.- <span class="cits_error"><%=msg%></span></div>
                                                                                                                                            <%                                                                                            }
                                                                                                                                            %>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td align="center" valign="middle">
                                                                                                                                        ...
                                                                                                                                        <table border="0" cellspacing="1" cellpadding="5" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#B3D5C0" class="cits_common_text_bold">Account Code :</td>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text"><%=actDetails.getAccountCode() %>                                                                                </td>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text">
                                                                                                                                                    <input type="hidden" name="hdnAccCode" id="hdnAccCode" class="cits_success" value="<%=actCode%>" maxlength="4" readonly/></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#B3D5C0" class="cits_common_text_bold">Account Type :</td>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text"><%=actDetails.getAccountType() %>
                                                                                                                                                    <input type="hidden" name="hdnAccountType" id="hdnAccountType" class="cits_common_text" value="<%=actDetails.getAccountType()%>"/>                                                                                </td>
                                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text">
                                                                                                                                                    <input name="txtAccType" type="text" class="cits_field_border" id="txtAccType" onFocus="hideMessage_onFocus()" value="<%=actType != null ? actType : ""%>" size="30" maxlength="30"/></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td align="left" valign="middle" bgcolor="#DFEFDE" class="cits_common_text">
                                                                                                                                                    <%
                                                                                                                                                        ...
                                                                                                                                                        if (actDetails.getStatus() == null)
                                                                                                                                                        {
                                                                                                                                                            stat = "N/A";
                                                                                                                                                        }
                                                                                                                                                        else if (actDetails.getStatus().equals(LCPL_Constants.status_active))
                                                                                                                                                        {
                                                                                                                                                            stat = "Active";
                                                                                                                                                        }
                                                                                                                                                        else if (actDetails.getStatus().equals(LCPL_Constants.status_deactive))
                                                                                                                                                        {
                                                                                                                                                            stat = "Inactive";
                                                                                                                                                        }
                                                                                                                                                        else

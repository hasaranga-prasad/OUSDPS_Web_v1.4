...
<%
    ...
    {
        transCode = request.getParameter("txtTransCode");
        ...
        result = transDAO.addTransType(new TransactionType(transCode, desc, transType, maxAmount, minAmount, maxValueDate, minValueDate, minReturnDate, maxReturnDate, concatMan1, concatMan2, concatMan3, desChargeAmt, orgChargeAmt, status, userName));

        if (!result)
        {
            msg = transDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_transaction_maintenance_add_new_transaction_types, "| Trans. Code - " + transCode + ", Description - " + desc + ", Type - " + transType + ", Min. Amount - " + minAmount + ", Max. Amount - " + maxAmount + ", Min. Value Date - " + minValueDate + ", Max. Value Date - " + maxValueDate + ", Min. Return Date - " + minReturnDate + ", Max. Return Date - " + maxReturnDate + ", Validation 1 - " + concatMan1 + ", Validation 2 - " + concatMan2 + ", Validation 3 - " + concatMan3 + ", Destination Charge Amount(Rs.) - " + desChargeAmt + ", Originator Charge Amount(Rs.) - " + orgChargeAmt + ", Status - " + status!= null?status.equals(LCPL_Constants.status_active)?"Active":"Inactive":"N/A" + " | Process Status - Unsuccess (" + msg + ") | Added By - " + userName + " (" + userTypeDesc + ") |"));
        }
        else
        {
            DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_transaction_maintenance_add_new_transaction_types, "| Trans. Code - " + transCode + ", Description - " + desc + ", Type - " + transType + ", Min. Amount - " + minAmount + ", Max. Amount - " + maxAmount + ", Min. Value Date - " + minValueDate + ", Max. Value Date - " + maxValueDate + ", Min. Return Date - " + minReturnDate + ", Max. Return Date - " + maxReturnDate + ", Validation 1 - " + concatMan1 + ", Validation 2 - " + concatMan2 + ", Validation 3 - " + concatMan3 + ", Destination Charge Amount(Rs.) - " + desChargeAmt + ", Originator Charge Amount(Rs.) - " + orgChargeAmt + ", Status - " + status!= null?status.equals(LCPL_Constants.status_active)?"Active":"Inactive":"N/A" + " | Process Status - Success | Added By - " + userName + " (" + userTypeDesc + ") |"));
        }
    }
%>
...
<html>
    <head><title>OUSDPS Web - Add Transaction Types</title>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            {
            document.getElementById('txtTransCode').setAttribute("autocomplete","off");
            ...
            {
            document.getElementById('txtTransCode').value = "";
            ...
            var tc = document.getElementById('txtTransCode').value;
            ...
            if(isempty(tc))
            {
				alert("Transaction Code Can't be Empty!");
				document.getElementById('txtTransCode').focus();
				return false;
            }
			else if (!numbers.test(tc)) 
            {
                alert("Transaction Code must contain numbers only!");
				document.getElementById('txtTransCode').focus();
                return false;
            }
            else if(tc.length!=2)
            {
                alert("Transaction Code must contain 2 digits!");
                document.getElementById('txtTransCode').focus();
                return false;
            }
            ...
            */
            ...
            {
            alert("Select Transaction Type Status !");
            document.getElementById('cmbStatus').focus();
            return false;
            }

            document.frmAddTransType.action="AddTransactionsTypes.jsp";
            document.frmAddTransType.submit();
            return true;
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%" height="16" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Add New Transaction Types</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="20"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top">
                                                                                            <form method="post" name="frmAddTransType" id="frmAddTransType">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="center">
                                                                                                            ...
                                                                                                            <div id="displayMsg_success" class="cits_Display_Success_msg" >
                                                                                                                ...
                                                                                                                Transaction Type added Sucessfully.
                                                                                                            ...
                                                                                                            <div id="displayMsg_error" class="cits_Display_Error_msg" >Transaction Type adding Failed.- <span class="cits_error"><%=msg%></span></div>
                                                                                                                <%                                                                                            }
                                                                                                                %>
                                                                                                                                ...
                                                                                                                                <td><table border="0" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td width="185" valign="middle" bgcolor="#DFEFDE"class="cits_tbl_header_text">
                                                                                                                                                <input name="txtTransCode" type="text" class="cits_field_border" id="txtTransCode" onFocus="hideMessage_onFocus()" value="<%=(transCode != null) ? transCode : ""%>" size="3" maxlength="2"/> </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                        ...
                                                                                                                                        <!--tr>
                                                                                                                                            ...
                                                                                                                                            <td bgcolor="#DFEFDE" valign="middle" class="cits_tbl_header_text">
                                                                                                                                                <select name="cmbTransType" id="cmbTransType" class="cits_field_border" onFocus="hideMessage_onFocus()" disabled>
                                                                                                                                                    <option value="-1" <%=(transType != null && transType.equals("-1")) ? "selected" : ""%>>--Select Type--</option>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td bgcolor="#DFEFDE" valign="middle" class="cits_tbl_header_text"><input name="txtMinAmount" type="text" class="cits_field_border_number" id="txtMinAmount" onFocus="hideMessage_onFocus()" value="<%=(minAmount != null) ? minAmount : "0.00"%>" size="14"  maxlength="12"/>                                                                                                                 </td>
                                                                                                                                        </tr>


                                                                                                                                        <tr>
                                                                                                                                            <td align="left" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Max Amount (Rs.) :</td>
                                                                                                                                            <td bgcolor="#DFEFDE" valign="middle" class="cits_tbl_header_text"> <input name="txtMaxAmount" type="text" class="cits_field_border_number" id="txtMaxAmount" onFocus="hideMessage_onFocus()" value="<%=(maxAmount != null) ? maxAmount : "5000000.00"%>" size="14"  maxlength="12"/>                                                                                                                  </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td align="left" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Min Value Date :</td>
                                                                                                                                            <td bgcolor="#DFEFDE" valign="middle" class="cits_tbl_header_text">   <input name="txtMinValDate" type="text" class="cits_field_border" id="txtMinValDate" onFocus="hideMessage_onFocus()" value="<%=(minValueDate != null) ? minValueDate : "0"%>" size="14"  maxlength="12"/>                                                                                                               </td>
                                                                                                                                        </tr>


                                                                                                                                        <tr>
                                                                                                                                            <td align="left" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Max Value Date  :</td>
                                                                                                                                            <td bgcolor="#DFEFDE" valign="middle" class="cits_tbl_header_text"><input name="txtMaxValDate" type="text" class="cits_field_border" id="txtMaxValDate" onFocus="hideMessage_onFocus()" value="<%=(maxValueDate != null) ? maxValueDate : "14"%>" size="14"  maxlength="12"/>                                                                                                                  </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td bgcolor="#DFEFDE" valign="middle" class="cits_tbl_header_text"><input name="txtDesChargeAmount" type="text" class="cits_field_border_number" id="txtDesChargeAmount" onFocus="hideMessage_onFocus()" value="<%=(desChargeAmt != null) ? desChargeAmt : "0.00"%>" size="14"  maxlength="12"/></td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td align="left" valign="middle" bgcolor="#B3D5C0" class="cits_tbl_header_text">Originator Charge Amount (Rs.) :</td>
                                                                                                                                            <td bgcolor="#DFEFDE" valign="middle" class="cits_tbl_header_text"><input name="txtOrgChargeAmount" type="text" class="cits_field_border_number" id="txtOrgChargeAmount" onFocus="hideMessage_onFocus()" value="<%=(orgChargeAmt != null) ? orgChargeAmt : "0.00"%>" size="14"  maxlength="12"/></td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>

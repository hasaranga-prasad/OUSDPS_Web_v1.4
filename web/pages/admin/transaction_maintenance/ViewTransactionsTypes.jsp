...
<%
    ...
    DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_admin_transaction_maintenance_view_transaction_types, "| Search Criteria - (All) | Result Count - " + col.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
%>
                                                                                                        ...
                                                                                                        <table border="0" cellspacing="0" cellpadding="0" class="cits_table_boder"><tr><td>
                                                                                                                    ...
                                                                                                                    <table border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF">
                                                                                                                        ...
                                                                                                                        <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>"  onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                            ...
                                                                                                                            <td align="right" class="cits_common_text"><%=transType.getiMinValueDate()%></td>
                                                                                                                            <td align="right" class="cits_common_text"><%=transType.getiMaxValueDate()%></td>
                                                                                                                            <td align="right" class="cits_common_text"><%=transType.getMinReturnDate()%></td>
                                                                                                                            <td align="right" class="cits_common_text"><%=transType.getMaxReturnDate() != null ? transType.getMaxReturnDate() : ""%></td>
                                                                                                                            <td align="right" class="cits_common_text"><%=transType.getMan1() != null ? transType.getMan1() : ""%></td>
                                                                                                                            <td align="right" class="cits_common_text"><%=transType.getMan2() != null ? transType.getMan2() : ""%></td>
                                                                                                                            <td align="right" class="cits_common_text"><%=transType.getMan3() != null ? transType.getMan3() : ""%></td>

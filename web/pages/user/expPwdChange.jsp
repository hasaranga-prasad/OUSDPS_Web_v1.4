...
<%@page import="lk.com.ttsl.citos.dao.DAOFactory" errorPage="../../error.jsp"%>
<%@page import="lk.com.ttsl.citos.dao.custom.user.*" errorPage="../../error.jsp"%>
<%@page import="lk.com.ttsl.citos.dao.user.pwd.history.*" errorPage="../../error.jsp"%>
<%@page import="lk.com.ttsl.citos.common.utils.CITOS_Constants" errorPage="../../error.jsp" %>
<%@page import="lk.com.ttsl.citos.dao.log.Log" errorPage="../../error.jsp"%>
<%@page import="lk.com.ttsl.citos.dao.log.LogDAO" errorPage="../../error.jsp"%>
...
<%
    ...
    else
    {
        ...
        else if (isInitLogin.equals(CITOS_Constants.status_no))
        {
    ...
    try
    {
        String strMinPwdHistory = DAOFactory.getParameterDAO().getParamValueById(CITOS_Constants.param_id_minimum_pwd_history);
    ...
    else if (isChangeReq.equals("1"))
    {
        ...
        if (result)
        {
            ...
            if (pwdHisUpdateStat)
            {
                session.setAttribute("session_isInitLogin", CITOS_Constants.status_no);
                session.setAttribute("session_userName", "null");
                DAOFactory.getLogDAO().addLog(new Log(CITOS_Constants.log_type_user_init_password_reset, "| User Name - " + userName + ") | Process Status - Success | Done By - " + userName + " (" + userTypeDesc + ") |"));
                response.sendRedirect("../../index.jsp?uName=" + userName);
            }
            else
            {
                msg = pwdHisDAO.getMsg();
                DAOFactory.getLogDAO().addLog(new Log(CITOS_Constants.log_type_user_init_password_reset, "| User Name - " + userName + ") | Process Status - Unsuccess update password history (" + msg + ") | Done By - " + userName + " (" + userTypeDesc + ") |"));
                response.sendRedirect("../login.jsp");
            }
        }
        else
        {
            msg = userDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(CITOS_Constants.log_type_user_init_password_reset, "| User Name - " + userName + ") | Process Status - Unsuccess (" + msg + ") | Done By - " + userName + " (" + userTypeDesc + ") |"));
            response.sendRedirect("../login.jsp");
        }
    }
...
<html>
    <head>
        <title>OUSDPS Web - Expired Password Change</title>
                ...
                if (frmChangeInitPwdActionVal == 1)
                {
                    ...
                    else
                    {
                        if (newPassword == confirmPassword)
                        {
                            ...
                            document.frmChangeInitPwd.action = "expPwdChange.jsp";
                            return true;
                        }
                        else
                        {
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" class="cits_body" onLoad="setAnimLights()">
        ...
        <form method="post" name="frmChangeExpPwd" onSubmit="return validate()">

            <table width="443" height="450" border="0" align="center" cellpadding="0" cellspacing="0" class="cits_bgExpPassword">
                <tr>
                    <td align="left" valign="bottom">

                        <table  border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td height="15" colspan="4" align="left" valign="bottom"><table width="420" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                            ...
                            <tr>
                                <td width="181"></td>
                              <td><input name="txtNewPwd" type="password"  class="cits_login_input_text" id="txtNewPwd" onKeyUp="validatePassword()" maxlength="32" style="min-width:220px;max-width:220px;min-height:16px"></td>
  ...
  <tr>
    ...
    <td><div id="validPwd" align="center" ><img src="../../images/animGreen.gif" name="imgOK" id="imgOK" width="12" height="12" ></div>
                            ...
                            <tr>
                                <td></td>
                                <td><input name="txtConfirmPwd" type="password"  class="cits_login_input_text" id="txtConfirmPwd" maxlength="32" style="min-width:220px;max-width:220px;min-height:16px"></td>
                                <td></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>

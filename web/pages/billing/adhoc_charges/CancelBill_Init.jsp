...
<%
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        colResult = DAOFactory.getBillingAdhocChargesDAO().getBillingAdhocChargeDetails(bankCode, branchCode, adhocChargeCode, LCPL_Constants.status_active, fromBillingDate, toBillingDate);

        DAOFactory.getLogDAO().addLog(new Log(LCPL_Constants.log_type_billing_adhoccharges_cancel_bill_search, "| Search Criteria - (Bank : " + bankCode + ", Branch : " + branchCode + ", Charge Type : " + adhocChargeCode + ", Billing Date (From : " + fromBillingDate + ", To : " + toBillingDate + "), Status : Active) | Result Count - " + colResult.size() + " | Viewed By - " + userName + " (" + userTypeDesc + ") |"));
    }
%>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="cits_header_text">Cancel Adhoc Charges Billing Data - Search</td>
                                                                                      <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="10"></td>
                                                                                        <td align="center" valign="top" class="cits_header_text"><form id="frmViewACB_Details" name="frmViewACB_Details" method="post" action="CancelBill_Init.jsp">
                                                                                                        ...
                                                                                                        <td><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                                                                                                <tr>
                                                                                                                    <td align="center" valign="top" ><table border="0" cellspacing="1" cellpadding="3" >
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td colspan="4" align="right" valign="middle" bgcolor="#CDCDCD" class="cits_tbl_header_text"><!--Inward Branch : -->                                                                                                                                  <table cellpadding="0" cellspacing="0" border="0">
                                                                                                                                        <tr>
                                                                                                                        ...
                                                                                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                                                                                            <tr>
                                                                                                                                <td align="center"><table  border="0" cellspacing="1" cellpadding="3" class="cits_table_boder" bgcolor="#FFFFFF">
                                                                                                                                        ...
                                                                                                                                        %>
																																		<form name="frmGoToConfirmCancel" id="frmGoToConfirmCancel" method="post" action="CancelBill_Confirmation.jsp">
                                                                                                                                        <tr bgcolor="<%=rowNum % 2 == 0 ? "#E4EDE7" : "#F5F7FA"%>"  onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                                          ...
                                                                                                                                          <td  class="cits_common_text"><%=bac.getBillingDate()%></td>
                                                                                                                                            ...
                                                                                                                                            <td align="center" nowrap  class="cits_common_text"><input type="hidden" name="hdnBillingId" id="hdnBillingId" value="<%=bac.getBillingId()%>">
                                                                                                                <input type="hidden" id="hdnBank" name="hdnBank" value="<%=bankCode %>" />
                                                                                                                <input type="hidden" id="hdnBranch" name="hdnBranch" value="<%=branchCode %>" />
                                                                                                                                                                                                                           
                                                                                                                <input type="hidden" id="hdnACT" name="hdnACT" value="<%=adhocChargeCode %>" />
                                                                                                                
                                                                                                                <input type="hidden" id="hdnFromBD" name="hdnFromBD" value="<%=fromBillingDate %>" /> 
                                                                                                                
                                                                                                                <input type="hidden" id="hdnToBD" name="hdnToBD" value="<%=toBillingDate %>" />
                                                                                                          <input type="submit" name="btnView" id="btnView" value="Cancel" class="cits_custom_button_small" ></td>
                                                                                                                                        </tr>
                                                                                                                                        </form>
                                                                                                                                        <%
                                                                                                                                            }

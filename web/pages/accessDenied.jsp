...
<html>
<head>
<title>OUSDPS Web - Access Denied</title>
                                        ...
                                        <td height="22"><table width="100%" height="22" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td align="left"><div style="padding:1;height:100%;width:100%;">
                                                            ...
                                                            <script language="JavaScript" vqptag="doc_level_settings" is_vqp_html=1 vqp_datafile0="<%=request.getContextPath()%>/js/reLoginMenu.js" vqp_uid0=399990>cdd__codebase = "<%=request.getContextPath()%>/js/";cdd__codebase399990 = "<%=request.getContextPath()%>/js/";</script>
                                                            <script language="JavaScript" vqptag="datafile" src="<%=request.getContextPath()%>/js/reLoginMenu.js"></script>
                                                            <script vqptag="placement" vqp_menuid="399990" language="JavaScript">create_menu(399990)</script>
                                                        </div></td>
                                                    <td>&nbsp;</td>
...
<tr>
                                    ...
                                    <tr>
<td height="100" align="center" valign="middle" class="cits_bgAccessdenied">&nbsp;</td>

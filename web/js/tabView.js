...
************************************************************************************************************/
	...
	function showTab(parentId,tabIndex)
	{
		...
		if(activeTabIndex[parentId]>=0){
			...
			img.src = relativePath + 'images/tab_right_inactive.gif';
		...
		img.src = relativePath + 'images/tab_right_active.gif';
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = relativePath + 'images/tab_right_over.gif';
		}
	...
	{
		this.src = this.src.replace(relativePath + 'images/close.gif', relativePath + 'images/close_over.gif');
	}

	function stopHoverTabViewCloseButton()
	{
		this.src = this.src.replace(relativePath + 'images/close_over.gif', relativePath + 'images/close.gif');
	}

	function initTabs(mainContainerID,tabTitles,activeTab,width,height,folderLevel,closeButtonArray,additionalTab)
	{
		...
		for(var no=0;no<tabTitles.length;no++){
			...
			if(closeButtonArray[no]){
				...
				closeButton.src = relativePath + 'images/close.gif';

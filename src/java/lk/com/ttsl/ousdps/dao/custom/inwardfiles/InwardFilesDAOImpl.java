 ...
 * @author Dinesh
 */
public class InwardFilesDAOImpl implements InwardFilesDAO
{
    ...
    public InwardFiles getInwardFileDetails(String iwdFilePath, String type, String okToDownload)
    {
        ...
        try
        {
            ...
            sbQuery.append("select rp.ReportName, rp.ReportPath, rp.ReportType, rp.BankCode, "
            ...
            sbQuery.append(LCPL_Constants.tbl_inwardfiles + " rp, ");
            ...
            if (!iwdFilePath.equals(LCPL_Constants.status_all))
            {
                sbQuery.append("and rp.ReportPath = ? ");
            ...
            report = InwardFilesUtil.makeReportObject(rs);
        }
        catch (Exception e)
        {
    ...
    public Collection<InwardFiles> getInwardFileDetails(String bankCode, String session, String type, String status, String fromBusinessDate, String toBusinessDate)
    {
        Collection<InwardFiles> col = null;
        Connection con = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
        ...
        try
        {
            ...
            rs = pstm.executeQuery();
            col = InwardFilesUtil.makeReportObjectCollection(rs);
        }
        catch (Exception e)
        {
            msg = LCPL_Constants.msg_error_while_processing;
    ...
    public boolean updateDownloadDetails(String iwdFilePath, String downloadedBy)
    {
        ...
        try
        {
            ...
            sbQuery.append(LCPL_Constants.tbl_inwardfiles + " ");
            sbQuery.append("set IsAlreadyDownloaded = ?, DownloadedBy = ?, DownloadedTime = NOW() ");
            sbQuery.append("where ReportPath = ? ");
    ...
    public boolean isSubBankInwardFileAvailable(String bankCode, String session, String type, String status, String fromBusinessDate, String toBusinessDate)
    {
